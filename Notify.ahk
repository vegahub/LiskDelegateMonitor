...
;覧覧覧覧      Notify() 0.4991 by gwarble       覧覧覧覧
;覧覧・                                           覧覧・
;覧・     easy multiple tray area notifications     覧・
;覧    http://www.autohotkey.net/~gwarble/Notify/    覧
;覧覧覧覧覧覧覧覧覧覧覧覧覧覧覧覧覧覧覧覧覧覧覧覧覧覧覧
;
...
Message= World
Duration=30
Options:="GC=asdasd TC=White MC=White"
if notifyid	
	notifyid := Notify(Title,"me",Duration,"UPDATE=" notifyid) ;= pretty simple
else
notifyid := Notify(Title,Message,Duration,Options) ;= pretty simple
return
